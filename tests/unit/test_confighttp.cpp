...
TEST(ConfigHttpDriverStatusTest, BuildsLiveVirtualInputDriverStatus) {
  ...
  EXPECT_EQ(virtualhid["minimum_version"].get<std::string>(), "2026.826.2024.22");  // NOSONAR(cpp:S1313): not an IP address
  EXPECT_EQ(virtualhid["supported_versions"].get<std::string>(), ">= 2026.826.2024.22");  // NOSONAR(cpp:S1313): not an IP address
