...
namespace platf {
  ...
  public:
    static std::string default_accessibility_log_msg() {
     ...
     * @return returns true if sunshine has Accessibility permission enabled
     */
    bool has_accessibility_permission_cached();
     ...
     * @return returns true if requested permission, false if already has permission
     */
    bool request_accessibility_permission_once();
     ...
     */
    void print_accessibility_status(const bool is_keyboard_event, const bool release);
  };
}  // namespace platf
