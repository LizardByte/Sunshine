...
#undef _CONVERT_2_ARG_
  ...
  void apply_config(std::unordered_map<std::string, std::string> &&vars) {
    ...
    string_restricted_f(vars, "keyboard_backend"s, input.keyboard_backend, {"virtualhid"sv, "logitech_ghub"sv});
    string_restricted_f(vars, "mouse_backend"s, input.mouse_backend, {"virtualhid"sv, "logitech_ghub"sv});
